...
<object data="./pdf/practice_2022.pdf" type="application/pdf" width="700px" height="700px">
    <embed src="./practice/pdf/practice_2022.pdf">
        <p>This browser does not support PDFs. Please download the PDF to view it: <a href="./practice/pdf/practice_2022.pdf">Download PDF</a>.</p>
    </embed>
</object>
bb
